...
floatHwPts = parseFloat(prompt("Please enter your total homework points (0-30):"));

floatMidPts = parseFloat(prompt("Please enter your midterm points (0-35):"));

floatFinPts = parseFloat(prompt("Please enter your final points (0-35):"));

floatTotalPts = parseFloat(floatHwPts + floatMidPts + floatFinPts);

intGradeOption = parseFloat(prompt("Enter 1 to audit pass/fail or 2 for letter grade"));
