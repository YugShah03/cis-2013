...
var passwordCheckOld = function () 
{
    ...
    {
        $("output").value = "Nope... Your password must be longer than 8 characters!";
        $("password").value = stringOutput;
    }
    else
    {
        for (var a = 0; a <= stringPassword.length; a++)
        {
            ...
            {
                $("output").value = "Nope... Your password belongs to a list of known bad passwords!";
                $("password").value = stringOutput;
                break;
            }
            else
            {
                $("output").value = "Yup... Your password meets all requirments!";
                $("password").value = stringOutput;
            }
